...
namespace A0530_LINQ_SQL.Sample
{
    ...
    partial void OnValueChanged();
		...
		[Column(Name="value", Storage="_Value", DbType="VarChar(10)")]
		public string Value
		{
			get
			{
		...
		[Association(Name="Test_main_Test_sub", Storage="_Test_sub", ThisKey="Id", OtherKey="Main_id")]
    ...
    partial void OnValueChanged();
		...
		[Column(Name="main_id", Storage="_Main_id", DbType="Int")]
		...
		[Association(Name="Test_main_Test_sub", Storage="_Test_main", ThisKey="Main_id", OtherKey="Id", IsForeignKey=true)]
